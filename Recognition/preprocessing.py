...
if mode.face:
    ...
    preprocessing_images_detect_face("../../newDataset/train/sad/*", "../../Face_detect_dataset/train/sad")
    print("done-train-Sad")
    preprocessing_images_detect_face("../../newDataset/train/fear/*", "../../Face_detect_dataset/train/fear")
    print("done-train-fear")
    preprocessing_images_detect_face("../../newDataset/train/angry/*", "../../Face_detect_dataset/train/angry")
    print("done-train-angry")
    preprocessing_images_detect_face("../../newDataset/train/happy/*", "../../Face_detect_dataset/train/happy")
    print("done-train-happy")
    preprocessing_images_detect_face("../../newDataset/train/surprised/*", "../../Face_detect_dataset/train/surprise")
    print("done-train-surprise")
    preprocessing_images_detect_face("../../newDataset/train/neutral/*", "../../Face_detect_dataset/train/neutral")
    print("done-train-neutral")
    preprocessing_images_detect_face("../../newDataset/train/disgusted/*", "../../Face_detect_dataset/train/disgust")
    print("done-train-disgust")

    ''' Test data '''
    print("it starts for test data")
    preprocessing_images_detect_face("../../newDataset/test/sad/*", "../../Face_detect_dataset/test/sad")
    print("done-test-sad")
    preprocessing_images_detect_face("../../newDataset/test/fear/*", "../../Face_detect_dataset/test/fear")
    print("done-test-fear")
    preprocessing_images_detect_face("../../newDataset/test/angry/*", "../../Face_detect_dataset/test/angry")
    print("done-test-angry")
    preprocessing_images_detect_face("../../newDataset/test/happy/*", "../../Face_detect_dataset/test/happy")
    print("done-test-happy")
    preprocessing_images_detect_face("../../newDataset/test/surprised/*", "../../Face_detect_dataset/test/surprise")
    print("done-test-surprise")
    preprocessing_images_detect_face("../../newDataset/test/neutral/*", "../../Face_detect_dataset/test/neutral")
    print("done-test-neutral")
    preprocessing_images_detect_face("../../newDataset/test/disgusted/*", "../../Face_detect_dataset/test/disgust")
    print("done-test-disgust")

if mode.eyeMouth:
    ''' Train data '''
    print("it starts for train data")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/sad/*","../../Eye_mouth_dataset/train/sad")
    print("done-train-Sad")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/fear/*","../../Eye_mouth_dataset/train/fear")
    print("done-train-fear")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/happy/*","../../Eye_mouth_dataset/train/happy")
    print("done-train-happy")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/angry/*","../../Eye_mouth_dataset/train/angry")
    print("done-train-angry")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/disgusted/*","../../Eye_mouth_dataset/train/disgust")
    print("done-train-disgust")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/surprised/*","../../Eye_mouth_dataset/train/surprise")
    print("done-train-surprise")
    preprocessing_images_detect_eye_mouth("../../newDataset/train/neutral/*","../../Eye_mouth_dataset/train/neutral")
    print("done-train-neutral")

    ''' Test data '''
    print("it starts for test data")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/sad/*", "../../Eye_mouth_dataset/test/sad")
    print("done-test-Sad")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/fear/*", "../../Eye_mouth_dataset/test/fear")
    print("done-test-fear")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/happy/*", "../../Eye_mouth_dataset/test/happy")
    print("done-test-happy")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/angry/*", "../../Eye_mouth_dataset/test/angry")
    print("done-test-angry")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/disgusted/*", "../../Eye_mouth_dataset/test/disgust")
    print("done-test-disgust")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/surprised/*", "../../Eye_mouth_dataset/test/surprise")
    print("done-test-surprise")
    preprocessing_images_detect_eye_mouth("../../newDataset/test/neutral/*", "../../Eye_mouth_dataset/test/neutral")
    print("done-test-neutral")
